export interface SplashDataPasswordEntry {
  year: number
  rank: number
  password: string
}

const SPLASHDATA_ROWS: string[][] = [
...
const SPLASHDATA_YEARS = [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019]

export const SPLASHDATA_PASSWORDS: SplashDataPasswordEntry[] = SPLASHDATA_ROWS.flatMap((row, rowIndex) =>
  row.map((password, yearIndex) => ({
    year: SPLASHDATA_YEARS[yearIndex],
    rank: rowIndex + 1,
    password,
  }))
)
